...
//		CustomFonts.setFontOfTextView(mContext,tvToolBar,"fonts/GothamRnd-Light.otf");
	...
	public void afterTextChanged(Editable s) {
		if(llFields.getVisibility()==View.VISIBLE)
		{
			...
			{
				if(etEmailAddress.getText().toString().trim().equals("") || etPassword.getText().toString().trim().equals("") || etBrideName.getText().toString().trim().equals("") || etGroomName.getText().toString().trim().equals("") || etArea.getText().toString().trim().equals("")  || etContactNumber.getText().toString().trim().equals(""))
				{
					btnSignIn.setEnabled(false);
					btnSignIn.setBackgroundColor(Color.parseColor("#F9B9BA"));
				}
				else if(!etEmailAddress.getText().toString().trim().equals("") && !etPassword.getText().toString().trim().equals("") && !etBrideName.getText().toString().trim().equals("") && !etGroomName.getText().toString().trim().equals("") && !etArea.getText().toString().trim().equals("") && !etContactNumber.getText().toString().trim().equals(""))
				{
					btnSignIn.setEnabled(true);
					btnSignIn.setBackgroundColor(Color.parseColor("#E4484B"));
				}
